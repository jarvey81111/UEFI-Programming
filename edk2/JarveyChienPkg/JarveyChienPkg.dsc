...
[Defines]
  PLATFORM_NAME                  = JarveyChienPkg
  PLATFORM_GUID                  = 252dea3f-c242-416f-83b7-6988929f0253
  PLATFORM_VERSION               = 0.01
  DSC_SPECIFICATION              = 0x00010006
  OUTPUT_DIRECTORY               = Build/JarveyChienPkg
...
#### Sample Applications.
  JarveyChienPkg/Applications/Hello/Hello.inf        # No LibC includes or functions.
  JarveyChienPkg/Applications/Main/Main.inf          # Simple invocation. No other LibC functions.
  JarveyChienPkg/Applications/Enquire/Enquire.inf    #
  JarveyChienPkg/Applications/ArithChk/ArithChk.inf  #
  JarveyChienPkg/Applications/CurrentTime/CurrentTime.inf
  JarveyChienPkg/Applications/CurrentTime/CurrentTimeShellC.inf

#### A simple fuzzer for OrderedCollectionLib, in particular for
#### BaseOrderedCollectionRedBlackTreeLib.
  JarveyChienPkg/Applications/OrderedCollectionTest/OrderedCollectionTest.inf {
    <LibraryClasses>
